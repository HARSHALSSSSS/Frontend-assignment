              ...
              <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#79F1A4] to-[#0E5CAD] rounded-lg flex">
                <div className="p-3">
                  <img
                    ...
                    src="https://img.etimg.com/thumb/width-420,height-315,imgsize-34660,resizemode-75,msid-90592357/markets/stocks/news/things-you-need-to-keep-in-mind-while-investing-in-us-stocks/piggybank-sk-ziqvkgsk-unsplash.jpg"
                    alt=""
                  />
                </div>
            ...
            <div className="mt-4 lg:ml-8">
              <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#FF9865] to-[#EF3031] rounded-lg flex">
                <div className="p-3">
                  <img
                    className="w-32 h-32 rounded-xl object-right object-cover"
                    src="https://www.velocenetwork.com/wp-content/uploads/2024/07/sajad-nori-oPRU2Cne0Pw-unsplash-800x500.jpg?ezimgfmt=rs:371x204/rscb1/ngcb1/notWebP"
                    alt=""
                  />
                </div>
                <div className="items-center p-4 flex flex-col justify-center mr-10">
